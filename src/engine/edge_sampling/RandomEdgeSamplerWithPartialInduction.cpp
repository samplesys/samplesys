...
vector<pair<size_t, size_t>> RandomEdgeSamplerWithPartialInduction::_sample(
...
vector<pair<size_t, size_t>> RandomEdgeSamplerWithPartialInduction::sample(const Graph &g) {
